...
Keep resource definitions simple, put logic in services.
{% endstep %}
...
Use docstrings and OpenAPI specs.
{% endstep %}
...
* [API Documentation](file:///docs/api)
* [Flask Documentation](https://flask.palletsprojects.com/)
* [Eve Documentation](https://docs.python-eve.org/)

## Next Steps

* Explore the [Client Documentation](file:///docs/developer-guide/client)
* Learn about [Planning Module](file:///docs/developer-guide/planning)
* Check the [API Reference](file:///docs/api)
